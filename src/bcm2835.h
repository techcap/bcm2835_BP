...
extern "C" {
	...
	extern void bcm2835_gpio_fsel(int pin, uint8_t mode);
	...
	extern uint8_t bcm2835_gpio_lev(int pin);
	...
	extern uint8_t bcm2835_gpio_eds(int pin);

	/// Sets the Event Detect Status register for a given pin to 1, 
	/// which has the effect of clearing the flag. Use this afer seeing
	/// an Event Detect Status on the pin.
	/// \param[in] pin GPIO number, or one of RPI_GPIO_P1_* from \ref RPiGPIOPin.
	extern void bcm2835_gpio_set_eds(int pin);
	...
	/// \param[in] pin GPIO number, or one of RPI_GPIO_P1_* from \ref RPiGPIOPin.
	extern void bcm2835_gpio_ren(int pin);

	/// Disable Rising Edge Detect Enable for the specified pin.
	/// \param[in] pin GPIO number, or one of RPI_GPIO_P1_* from \ref RPiGPIOPin.
	extern void bcm2835_gpio_clr_ren(int pin);
	...
	/// has the effect of suppressing glitches.
	/// \param[in] pin GPIO number, or one of RPI_GPIO_P1_* from \ref RPiGPIOPin.
	extern void bcm2835_gpio_fen(int pin);

	/// Disable Falling Edge Detect Enable for the specified pin.
	/// \param[in] pin GPIO number, or one of RPI_GPIO_P1_* from \ref RPiGPIOPin.
	extern void bcm2835_gpio_clr_fen(int pin);
	...
	/// \param[in] pin GPIO number, or one of RPI_GPIO_P1_* from \ref RPiGPIOPin.
	extern void bcm2835_gpio_aren(int pin);

	/// Disable Asynchronous Rising Edge Detect Enable for the specified pin.
	/// \param[in] pin GPIO number, or one of RPI_GPIO_P1_* from \ref RPiGPIOPin.
	extern void bcm2835_gpio_clr_aren(int pin);
	...
	/// \param[in] pin GPIO number, or one of RPI_GPIO_P1_* from \ref RPiGPIOPin.
	extern void bcm2835_gpio_afen(int pin);

	/// Disable Asynchronous Falling Edge Detect Enable for the specified pin.
	/// \param[in] pin GPIO number, or one of RPI_GPIO_P1_* from \ref RPiGPIOPin.
	extern void bcm2835_gpio_clr_afen(int pin);
	...
	/// \sa bcm2835_gpio_set_pud()
	extern void bcm2835_gpio_pudclk(int pin, uint8_t on);
	...
	extern void bcm2835_gpio_write(int pin, uint8_t on);
	...
	/// \param[in] pin GPIO number, or one of RPI_GPIO_P1_* from \ref RPiGPIOPin.
	/// \param[in] pud The desired Pull-up/down mode. One of BCM2835_GPIO_PUD_* from bcm2835PUDControl
	extern void bcm2835_gpio_set_pud(int pin, uint8_t pud);
